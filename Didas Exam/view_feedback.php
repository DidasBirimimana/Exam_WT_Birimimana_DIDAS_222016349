       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['FeedbackID']; // Fetch the ReportID
                echo "<tr>
                    ...
                    <td>" . $row['Comments'] . "</td>
                    <td>" . $row['Timestamp'] . "</td>
                    <td><a style='padding:4px' href='delete_feedback.php?FeedbackID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_feedback.php?FeedbackID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['UserID']; // Fetch the UserID
                echo "<tr>
                    <td>" . $row['UserID'] . "</td>
                    <td>" . $row['ListingID'] . "</td>
                    <td><a style='padding:4px' href='delete_favorities.php?UserID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_favorities.php?UserID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

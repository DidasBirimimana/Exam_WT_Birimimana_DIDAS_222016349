       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['PaymentID']; // Fetch the PaymentID
                echo "<tr>
                    <td>" . $row['PaymentID'] . "</td>
                    <td>" . $row['UserID'] . "</td>
                    <td>" . $row['Amount'] . "</td>
                    <td>" . $row['Timestamp'] . "</td>
                    <td>" . $row['Status'] . "</td>
                    <td><a style='padding:4px' href='delete_payments.php?PaymentID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_payments.php?PaymentID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

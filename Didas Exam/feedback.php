...
<head>
    ...
    <!-- JavaScript validation and content load for insertion -->
    <script>
...
<body>
    <center>
        ...
        <form method="post" onsubmit="return confirmInsert();">
            ...
            <label for="FromUserID">FromUserID:</label>
            ...
            <input type="time" id="CC" name="CC" required><br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO feedback(FeedbackID, FromUserID, ToUserID, ListingID, Rating, Comments, Timestamp) VALUES (?, ?, ?, ?, ?, ?, ?)");
        $stmt->bind_param("issssss", $FeedbackID, $FromUserID, $ToUserID, $ListingID, $Rating, $Comments, $Timestamp);
        
        // Set parameters and execute
        $FeedbackID = $_POST['insId'];
        $FromUserID = $_POST['title'];
        $ToUserID = $_POST['content'];
        $ListingID = $_POST['PP'];
        $Rating = $_POST['dd'];
        $Comments = $_POST['pr'];
        $Timestamp = $_POST['CC'];

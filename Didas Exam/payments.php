...
<form method="post" onsubmit="return confirmInsert();">
    ...
    <input type="time" id="tt" name="tt" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO payments(PaymentID, UserID,Amount,Timestamp,Status) VALUES (?, ?, ? ,? ,?)");
    $stmt->bind_param("iisss", $PaymentID, $UserID, $Amount,$Timestamp,$Status);
    // Set parameters and execute
    $PaymentID = $_POST['insId'];
    $UserID = $_POST['title'];
    $Amount = $_POST['content'];
    $Timestamp = $_POST['tt'];
    $Status = $_POST['Status'];

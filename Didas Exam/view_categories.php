        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_categories.php?CategoryID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_categories.php?CategoryID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

...
<section>
    ...
    <center>
        ...
        <form method="post" onsubmit="return confirmInsert();">
            ...
            <input type="time" id="PP" name="PP" required><br><br>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $connection->prepare("INSERT INTO reports(ReportID, UserID, ListingID, Timestamp, Reason) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("issss", $ReportID, $UserID, $ListingID, $Timestamp, $Reason);
        
        // Set parameters and execute
        $ReportID = $_POST['insId'];
        $UserID = $_POST['title'];

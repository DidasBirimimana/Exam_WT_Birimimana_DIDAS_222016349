       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['ImageID']; // Fetch the ImageID
                echo "<tr>
                    <td>" . $row['ImageID'] . "</td>
                    <td>" . $row['ListingID'] . "</td>
                    <td>" . $row['ImageURL'] . "</td>
                    <td>" . $row['Description'] . "</td>
                    <td><a style='padding:4px' href='delete_images.php?ImageID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_images.php?ImageID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['InstructorID']; // Fetch the InstructorID
                echo "<tr>
                    <td>" . $row['InstructorID'] . "</td>
                    <td>" . $row['UserID'] . "</td>
                    <td>" . $row['Bio'] . "</td>
                    <td><a style='padding:4px' href='delete_instructors.php?InstructorID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_instructors.php?InstructorID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

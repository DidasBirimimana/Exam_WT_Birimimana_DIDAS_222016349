...
<body>
    <center><h2>Table of Image</h2></center>
    <table border="5">
        <tr>
       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['MessageID']; // Fetch the MessageID
                echo "<tr>
                    <td>" . $row['MessageID'] . "</td>
                    <td>" . $row['SenderID'] . "</td>
                    ...
                    <td>" . $row['Timestamp'] . "</td>
                    <td>" . $row['Content'] . "</td>
                    <td><a style='padding:4px' href='delete_messages.php?MessageID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_messages.php?MessageID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

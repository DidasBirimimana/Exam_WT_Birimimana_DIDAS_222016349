...
<body>
    <center><h2>Table of ads</h2></center>
    <table border="5">
        <tr>
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all ads
        $sql = "SELECT * FROM ads";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['AdID']; // Fetch the AdID
                echo "<tr>
                    <td>" . $row['AdID'] . "</td>
                    <td>" . $row['UserID'] . "</td>
                    <td>" . $row['ListingID'] . "</td>
                    ...
                    <td>" . $row['Status'] . "</td>
                    <td><a style='padding:4px' href='delete_ads.php?AdID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_ads.php?AdID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO images(ImageID, ListingID, ImageURL, Description) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $ImageID, $ListingID, $ImageURL, $Description);
    // Set parameters and execute
    $ImageID = $_POST['insId'];
    $ListingID = $_POST['title'];
    $ImageURL = $_POST['content'];
    $Description = $_POST['PP'];

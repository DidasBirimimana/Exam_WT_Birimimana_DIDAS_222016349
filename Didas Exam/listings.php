...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO listings(ListingID, Title, Description, Price, CategoryID, Location, DatePosted, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("isssssss", $ListingID, $Title, $Description, $Price, $CategoryID, $Location, $DatePosted, $Status);
    // Set parameters and execute
    $ListingID = $_POST['insId'];
    $Title = $_POST['title'];

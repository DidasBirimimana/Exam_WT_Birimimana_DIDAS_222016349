...
<section>
    ...
    <!--message form using for insertion data to database-->
<h1><u>Messages Form</u></h1>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO messages(MessageID, SenderID, ReceiverID, ListingID, Timestamp, Content) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $message_id, $sender_id, $receiver_id, $listing_id, $timestamp, $content);

...
<body>
    ...
    <table border="5">
       ...
       include('Database_Connection.php');
        ...
        // Prepare SQL query to retrieve all listings
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['ListingID']; // Fetch the ListingID
                echo "<tr>
                    <td>" . $row['ListingID'] . "</td>
                    <td>" . $row['Title'] . "</td>
                    ...
                    <td>" . $row['Status'] . "</td>
                    <td><a style='padding:4px' href='delete_listings.php?ListingID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_listings.php?ListingID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {

...
<body>
    <center>
        ...
        <form method="post" onsubmit="return confirmInsert();">
            ...
            <input type="text" id="ll" name="ll" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO ads(AdID, UserID, ListingID, Title, Description, Price, CategoryID, Location, DatePosted, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("iiisssssss", $AdID, $UserID, $ListingID, $Title, $Description, $Price, $CategoryID, $Location, $DatePosted, $Status);
    // Set parameters and execute
    $AdID = $_POST['insId'];
    $UserID = $_POST['title'];
    $ListingID = $_POST['content'];
    $Title = $_POST['PP'];

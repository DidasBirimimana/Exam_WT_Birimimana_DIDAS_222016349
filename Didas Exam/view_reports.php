       ...
       include('Database_Connection.php');
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                $instId = $row['ReportID']; // Fetch the ReportID
                echo "<tr>
                    <td>" . $row['ReportID'] . "</td>
                    <td>" . $row['UserID'] . "</td>
                    <td>" . $row['ListingID'] . "</td>
                    <td>" . $row['Timestamp'] . "</td>
                    <td>" . $row['Reason'] . "</td>
                    <td><a style='padding:4px' href='delete_reports.php?ReportID=$instId'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_reports.php?ReportID=$instId'>Update</a></td> 
                </tr>";
            }
        } else {
